...
public class PG01O
{
	...
	{
		return "ClassPojo [PAGE_SUBTITLE = "+PAGE_SUBTITLE+", PAGE_TITLE = "+PAGE_TITLE+", main_section = "+main_section+"]";
	}
}
...
class Main_section
{
	...
	public List<Section_links> section_links;
	...
	public String toString()
	{
		return "ClassPojo [more_pages_link_ic = "+more_pages_link_ic+", section_title = "+section_title+", section_links_att = "+section_links_att+", link_qtt = "+link_qtt+", section_id = "+section_id+", section_links = "+section_links+"]";
	}
}
