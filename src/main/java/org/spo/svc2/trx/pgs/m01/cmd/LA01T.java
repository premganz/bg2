...
public class LA01T
{
	...
	{
		return "ClassPojo [MENU_LINKS_AUDIENCE_ZN = "+MENU_LINKS_AUDIENCE_ZN+", MENU_LINKS_IDEA_ZN = "+MENU_LINKS_IDEA_ZN+", MENU_LINKS_INVOLVED_ZN = "+MENU_LINKS_INVOLVED_ZN+", MENU_LINKS_RESOURCES_ZN = "+MENU_LINKS_RESOURCES_ZN+", list_pagination_ic = "+list_pagination_ic+"]";
	}
